...
public class MainLogin extends JFrame implements LibWindow{
	...
	public void init() {
		...
		lblNewLabel_1.setBounds(171, 148, 156, 41);
		...
		lblNewLabel.setIcon(new ImageIcon(new ImageIcon(MainLogin.class.getResource("/librarysystem/library_portrait.jpeg")).getImage().getScaledInstance(lblNewLabel.getWidth(), lblNewLabel.getHeight(), Image.SCALE_SMOOTH)));
